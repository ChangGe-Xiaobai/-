    ...
    <div class="m-app newItem" style="background:#EEEEEE;">
      ...
      <div class="m-itemRankTab">
        <ul class="container">
          ...
          <li class="tab tab-newItem   tab-active">
            <i class="u-icon u-icon-rank-newItem-active"></i>
...
export default {
  ...
  mounted(){
        ...
        // })
        this.$http.get('../../static/js/newItemRank.json').then((res)=>{
...
@import url("../../static/css/newItemRank.css");
