    ...
    <div class="m-app newItem" style="background:#EEEEEE;">
      ...
      <div class="m-itemRankTab">
        <ul class="container">
          ...
          <li class="tab tab-praise tab-active">
            <i class="u-icon u-icon-rank-praise-active"></i>
...
export default {
  ...
  mounted(){
        ...
        // })
        this.$http.get('../../static/js/praiseRank.json').then((res)=>{
...
@import url("../../static/css/praiseRank.css");
