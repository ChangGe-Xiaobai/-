  ...
  <div>
    <div class="m-app newItem" style="background:#EEEEEE;">
      ...
      <div class="m-itemRankTab">
        <ul class="container">
          <li class="tab tab-sale">
            <i class="u-icon u-icon-rank-sale"></i>
            <span class="name"><router-link to='/saleRank'>热销榜</router-link></span>
          </li>
          <li class="tab tab-preferenti  tab-active">
            <i class="u-icon u-icon-rank-preferenti-active"></i>
...
export default {
  ...
  mounted(){
        ...
        // })
        this.$http.get('../../static/js/preferentiRank.json').then((res)=>{
...
@import url("../../static/css/preferentiRank.css");
